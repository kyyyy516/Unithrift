...
@override
 ...
 Future<void> _initializeVideo() async {
    if (widget.product['videoUrl'] != null) {
      ...
      videoUrl = videoUrl.replaceAll('view?usp=sharing', 'uc?export=download&id=');
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if (images.isNotEmpty || widget.product['videoUrl'] != null) ...[
                  Stack(
                    children: [
                      if (!_isVideo) ...[
                        // Image carousel
                      ...
                      RichText(
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: "${widget.product['brand/edition'] ?? 'N/A'}",
                              style: const TextStyle(
                                fontSize: 16,
                                color: Colors
                                    .black, // Black color for the actual category
                       ...
                       RichText(
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: "${widget.product['details'] ?? 'No Details Available'}",
                              style: const TextStyle(
                                fontSize: 16,
                                color: Colors
                                    .black, // Black color for the actual category
