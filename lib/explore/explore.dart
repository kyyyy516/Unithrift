...
class _ExploreState extends State<Explore> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const PopularRental()),
                );
              },
              child: featureBox(
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const CampusService()),
                );
              },
              child: featureBox(
  ...
  Widget featureBox({
    ...
    return Stack(
      children: [
        Padding(
          padding: const EdgeInsets.only(left: 30.0,top:10.0,right:5.0), // Add padding for image
          child: Container(
            ...
            padding: const EdgeInsets.only(left: 50.0, right: 10.0, top: 16.0, bottom: 16.0),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
