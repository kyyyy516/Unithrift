...
class TotalAddedtoCart extends StatefulWidget {
  const TotalAddedtoCart({super.key});

  @override
  State<TotalAddedtoCart> createState() => _TotalAddedtoCartState();
}

class _TotalAddedtoCartState extends State<TotalAddedtoCart> {
    ...
    return FirebaseFirestore.instance
      ...
      .asyncMap((productsSnapshot) async {
        ...
        for (var productDoc in productsSnapshot.docs) {
          ...
          // Check each user's cart collection
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.shopping_cart, size: 14, color: Colors.red),
                      const SizedBox(width: 4),
                      Text(
                        '${item['cart'] ?? 0} in carts',
